...
<body style="background-color: #422520; " id="top">
    ...
    <div class="controlpanel">
        ...
        <div class="controlpanelbody" style="background-color: white; padding-left: 5%; padding-top: 5%; font-size: 1.4em; height: 90%">
            Users logged in: <br>
            <?php
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "Name: " . $row["full_name"] . " - Username: " . $row["username"] . " - Email: " . $row["email"] . "<br>";
                }
            } else {
                echo "0 results";
            }
